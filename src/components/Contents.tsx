    ...
    <div className="px-36 my-32">
      <div className="flex flex-col justify-center gap-6  items-center">
        ...
        <div className="font-semibold text-4xl">
          <span className="text-[#212245]">we will </span>
      ...
      <div className="mt-24 flex justify-between">
        <div className="flex gap-5 flex-col justify-center w-56 text-center items-center">
          ...
          <h2 className="font-bold text-xl text-[#212245]">Quick Delivery</h2>
        ...
        <div className="flex gap-5 flex-col justify-center w-56 text-center items-center">
          ...
          <h2 className="font-bold text-xl text-[#212245]">Super Dine in</h2>
          <p className="text-gray-400">
        ...
        <div className="flex gap-5 flex-col justify-center w-56 text-center items-center">
          ...
          <h2 className="font-bold text-xl text-[#212245]">Easy Pick Up</h2>
          <p className="text-gray-400">
