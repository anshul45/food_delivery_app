      ...
      <div className="flex  items-center gap-10">
        ...
        <div className="flex flex-col gap-7">
          ...
          <p className="text-gray-400">
            ...
            assumenda delectus recusandae, nam, soluta dicta quibusdam, quos
            deleniti pariatur quis culpa maiores
          </p>
          <div className="flex flex-col gap-4">
            <h2 className="font-semibold">
              <i className="text-[#df2020] font-light ri-checkbox-circle-line"></i>{" "}
      ...
      <div className="flex mt-20">
        <div className="flex flex-col gap-5">
          ...
          <p className="text-gray-600 leading-8">
            ...
            ipsum quo iusto dolores aliquam sapiente natus! Odio, deserunt
            nihil?
          </p>
          <Carousel />
        </div>
