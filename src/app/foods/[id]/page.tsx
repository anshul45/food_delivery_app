...
const pages = () => {
  ...
  return (
    <div>
      <div>
      <div className=" bg-green-400 w-full py-20 pl-32 font-semibold text-4xl text-white">Product Name</div>
          <div className='flex items-center py-9'>
            ...
            <div className='flex-[0.5] flex flex-col gap-7'>
              ...
              <div className='flex gap-3 items-center'>
                ...
                <h1 className='font-semibold text-lg bg-[#fde4e4] px-2 py-1 rounded-md'>Burger</h1>
              </div>
              <button className='bg-[#df2020] w-fit px-4 py-2 font-semibold text-lg rounded-md text-white'>Add to Cart</button>
            </div>
          </div>
          <div className=' my-20 mx-32 '>
            <div className='  py-4 flex gap-12 font-semibold text-lg border-b-[1px] border-[#fde4e4]'>

            <div className={`cursor-pointer ${isOpenDesc?"text-[#df2020]":""}`}
             onClick={()=>{setIsOpenReview(!isOpenReview)
              setIsOpenDesc(!isOpenDesc)
              }}
            >Description</div>
            <div className={`cursor-pointer ${isOpenReview?"text-[#df2020]":""}`}
            onClick={()=>{setIsOpenReview(!isOpenReview)
            setIsOpenDesc(!isOpenDesc)
            }}>Review</div>
